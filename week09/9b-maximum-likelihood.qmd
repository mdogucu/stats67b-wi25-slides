...
If we observe a head what is the **likelihood** that this a fair coin, i.e., $\pi$ is 0.5?
...
Let $X \sim \text{Binomial}(n = 5, \pi = 0.2)$

Let X be the number of spam emails received among five emails with a 0.2 probability of spam email.

## $f(0)$

What is the probability that none of the emails received is spam?
...
What is the probability that one of the emails received is spam?
...
## $f(x)$ if $\pi = 0.2$ or $\pi = 0.4$ or $\pi = 0.8$
...
There were 5 emails received and 3 of them turned out to be spam. What is the likelihood that $\pi$ is 0.2 (i.e. $L(\pi = 0.2 | x = 3)$?
...
What about $L(\pi = 0.4 | x = 3)$ or  $L(\pi = 0.8 | x = 3)$? 
...
## Step 4: Set the first derivative equal to 0 and solve for $\pi$
